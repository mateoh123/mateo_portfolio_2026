...
const sections = ["Overview", "Problem", "Concept", "Process", "Album Covers"];

const projectInfo = [
  { label: "Role", value: "Lead, Solo Contributor" },
...
export default function AAC_Client({ folders }: Props) {
  return (
    <>
      <GoBack />
      <div className="flex justify-end items-end pt-[8vw]">
        <h1 className="origin-bottom mr-[0.5vw] md:text-[5vw] font-archivo text-black font-bold text-right scale-y-[3] leading-[0.8]">
