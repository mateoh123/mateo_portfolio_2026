...
"[project]/app/oosgd/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OOSGD_Page() {
    _s();
    const baseDir = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$path$2d$browserify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].join(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].cwd(), "public/assets/Work_Assets");
    const folders = {};
    fs.readdirSync(baseDir).forEach((folder)=>{
        const folderPath = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$path$2d$browserify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].join(baseDir, folder);
        if (fs.statSync(folderPath).isDirectory()) {
            folders[folder] = fs.readdirSync(folderPath).filter((f)=>/\.(jpg|jpeg|png|avif|webp)$/i.test(f)).map((f)=>`/assets/Work_Assets/${folder}/${f}`);
        }
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OOSGD_Page.useEffect": ()=>{
            const observers = sections.map({
                "OOSGD_Page.useEffect.observers": (section)=>{
                    const el = document.getElementById(section.toLowerCase());
                    const observer = new IntersectionObserver({
                        "OOSGD_Page.useEffect.observers": ([entry])=>{
                            if (entry.isIntersecting) setActive(section);
                        }
                    }["OOSGD_Page.useEffect.observers"], {
                        threshold: 0.5
                    });
            ...
            return ({
                "OOSGD_Page.useEffect": ()=>observers.forEach({
                        "OOSGD_Page.useEffect": (o)=>o.disconnect()
                    }["OOSGD_Page.useEffect"])
            })["OOSGD_Page.useEffect"];
        }
    }["OOSGD_Page.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                className: "relative min-h-screen overflow-hidden grid grid-cols-1 md:grid-cols-[1fr_1fr] lg:grid-cols-[1fr_3fr] bg-white",
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "hidden md:flex md:flex-col md:gap-15 m-[3vw]",
                        children: [
...
_s(OOSGD_Page, "VwqEi2F/z7wwoSQzUquo6f1LoBA=");
_c = OOSGD_Page;
var _c;
__turbopack_context__.k.register(_c, "OOSGD_Page");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_13h~qmz._.js.map